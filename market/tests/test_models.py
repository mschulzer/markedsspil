...
class TraderModelTest(TestCase):
    ...
    def test_prod_cost_algorithm(self):
        ...
        self.assertEqual(UnusedCosts.objects.all().count(), 2)
        ...
        self.assertEqual(UnusedCosts.objects.all().count(), 1)

        # There is 1 used cost
        self.assertEqual(UsedCosts.objects.all().count(), 1)
        ...
        self.assertEqual(UnusedCosts.objects.all().count(), 0)

        # There are 2 used costs
        self.assertEqual(UsedCosts.objects.all().count(), 2)
        ...
        self.assertEqual(UsedCosts.objects.all().count(), 3)
        ...
        self.assertEqual(UsedCosts.objects.all().count(), 4)
        ...
        self.assertEqual(UsedCosts.objects.all().count(), 5)
...
class TestRoundStatModel(TestCase):
    ...
    def test_object_creation_and_name(self):
        market = MarketFactory()
        r1 = RoundStat.objects.create(
            market=market, round=3, avg_price=Decimal('34.34'))
    ...
    def test_market_and_round_uinque_together(self):
        ...
        s1 = RoundStat.objects.create(
            market=market1, round=45, avg_price=34.343)
